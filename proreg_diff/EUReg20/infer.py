...
def main():
    val_dir = 'Data/proregus2_data/Test10_20/'
    ...
    model_dir = 'experiments/miccai2025/proreg_diff/' + save_dir
    ...
    pic_path = 'showdata/miccai2025/proreg_diff/'+save_dir
    ...
    with torch.no_grad():
        for data in test_loader:
            ...
            trans_l2 = losses.L2dist(pred_dof[:, :3], dof[:, :3]).item() * 0.8
            rot_l2 = losses.L2dist(pred_dof[:, 3:], dof[:, 3:]).item()
            dist_err = Lcorner(pred_dof, dof).item() * 0.8
