...
def main():
    ...
    val_loader = DataLoader(val_set, batch_size=1, shuffle=False, num_workers=10)
    ...
    for epoch in range(epoch_start, max_epoch):
        ...
        if (epoch+1) % 2 == 0 or epoch > max_epoch-5:
            ...
            }, save_dir='experiments/CAMUS/' + save_dir, filename='ParaErr{:.4f}_DistErr{:.4f}_epoch{}.pth.tar'.format(eval_ParaErr.avg,eval_DistErr.avg, epoch))
            loss_all.reset()
