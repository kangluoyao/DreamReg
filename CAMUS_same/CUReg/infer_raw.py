...
def main():
    val_dir = '/home/whq/Data/CAMUS_data/Test/'
    ...
    model_dir = '/home/whq/experiments/miccai2025/CAMUS_same/' + save_dir
    best_model = torch.load(model_dir + natsorted(os.listdir(model_dir))[0])
    ...
    with (torch.no_grad()):
        for data in test_loader:
            ...
            sampled_frame = vol[:,:,vol.shape[2]//2:vol.shape[2]//2+1]
            ender.record()
